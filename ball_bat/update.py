...
current_player2 = Rectangle(0, WINDOW_HEIGHT - 20, 140,
                            WINDOW_HEIGHT)  # initial rect of player2 bat # TODO: try different numbers
...
def display_section():
    ...
    glColor(1, current_color_anim,
            current_color_anim)  # red when current_color_anim = 0, white when current_color_anim = 1
